...
if __name__=="__main__":
    ...
    clf_list = [nn, knn,lr]   #添加了magic的,补充三个
    #
    #
    #
    column_list = []
    ...
    for clf in clf_list:
        ...
        for ind in range(ind_num):
            column_list.append("add_%s_%s" % (clf_name, ind))
    ...
    train.to_csv("magic_add1_train_stacking.csv", index=None)
    test.to_csv("magic_add1_test_stacking.csv", index=None)
