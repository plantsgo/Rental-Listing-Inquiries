...
if __name__=="__main__":
    ...
    clf_list = [gb_reg, rf_reg, et_reg]   #添加了magic的,补充三个reg
    #
    #
    #
    column_list = []
    ...
    train.to_csv("magic_regadd_train_stacking.csv", index=None)
    test.to_csv("magic_regadd_test_stacking.csv", index=None)
