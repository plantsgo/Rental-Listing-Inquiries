...
if __name__=="__main__":
    ...
    #
    #
    clf_list = [lgb,lgb_reg,xgb,nn,gb,rf,et,lr,rf_reg,gb_reg,et_reg,xgb_reg,nn_reg]
    #
    #
    #
    column_list = []
    ...
    train.to_csv("ori_train_stacking.csv", index=None)
    test.to_csv("ori_test_stacking.csv", index=None)
