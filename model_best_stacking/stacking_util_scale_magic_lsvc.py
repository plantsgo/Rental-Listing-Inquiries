...
if __name__=="__main__":
    ...
    clf_list = [lsvc]   #添加了magic的,补充三个reg
    #
    #
    #
    column_list = []
    ...
    for clf in clf_list:
        ...
        for ind in range(ind_num):
            column_list.append("lsvc_%s_%s" % (clf_name, ind))
    ...
    train.to_csv("magic_lsvc_train_stacking.csv", index=None)
    test.to_csv("magic_lsvc_test_stacking.csv", index=None)
