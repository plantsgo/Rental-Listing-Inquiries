...
if __name__=="__main__":
    ...
    for clf in clf_list:
        ...
        for ind in range(ind_num):
            column_list.append("ovrhl_%s_%s" % (clf_name, ind))
    ...
    train.to_csv("magic_ovrhl_train_stacking.csv", index=None)
    test.to_csv("magic_ovrhl_test_stacking.csv", index=None)
